...
<!-- Modal -->
<div class="modal fade" id="editTask-{{ $task->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel-{{ $task->id }}">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::model($task,['route'=>['tasks.update','task'=>$task->id],'method'=>'PATCH']) !!}
