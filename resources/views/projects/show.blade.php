...
@section('content')
    <div class="container tasks-tabs">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="active"><a href="#toDo" aria-controls="profile" role="tab" data-toggle="tab">未完成</a></li>
            ...
            <div class="tab-content">
                {{--未完成任务列表--}}
                <div role="tablepanel" class="tab-pane active" id="toDo">
                ...
                {{--已处理任务列表--}}
                <div role="tablepanel" class="tab-pane" id="Done">
                    <table class="table table-striped">
